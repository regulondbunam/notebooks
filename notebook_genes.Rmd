...
DESCRIPCION Seccion de datos generales
...
<a onclick="download_resources('datas/get_gene_general_statistics.csv')" 
...
This section displays the gene sizes in E.coli. Sizes have been calculated for each gene and tallied into size ranges, which can be seen in the table. The graph demonstrates the frequency of these size ranges.

<a onclick="download_resources('images/get_calculate_gene_intervals.png')" 
   style="font-style: italic; text-decoration: none; cursor: pointer;">Download Image</a>
   
<a onclick="download_resources('datas/get_calculate_gene_intervals.csv')" 
   style="font-style: italic; text-decoration: none; cursor: pointer;">Download Data</a>
...
In E. coli, genes are regulated by transcription factors (TFs). In this section, a table is presented showing the grouped and calculated TFs according to their gene regulation. Additionally, a graph illustrates the frequency of the total TFs.

<a onclick="download_resources('images/get_tfs_regulations_genes.png')" 
   style="font-style: italic; text-decoration: none; cursor: pointer;">Download Image</a>
   
<a onclick="download_resources('datas/get_tfs_regulations_genes.csv')" 
   style="font-style: italic; text-decoration: none; cursor: pointer;">Download Data</a>
